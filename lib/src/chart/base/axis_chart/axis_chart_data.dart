...
class FlDotImagePainter extends FlDotPainter {
  /// The color of the image is determined determined by [color],
  /// [radius] determines the radius of the image.
  /// You can have a stroke line around the image,
  /// by setting the thickness with [strokeWidth],
  /// and you can change the color of of the stroke with [strokeColor].
  FlDotImagePainter(this.image, {
    this.color = Colors.green,
    double? radius,
    this.strokeColor = const Color.fromRGBO(76, 175, 80, 1),
    this.strokeWidth = 0.0,
